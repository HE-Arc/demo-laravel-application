...
<div id="index-banner">
    <div class="parallax-container valign-wrapper">
        ...
        <div class="container valign">
            ...
            <div class="row center">
                <p>
                    <a href="{{ route('vote', compact('lang')) }}" class="btn-large waves-effects waves-light">
                        {{ trans('messages.Vote') }}
                        <i class="mdi-action-favorite material-icons left"></i>
                    </a>
                    <a class="btn-flat waves-effect waves-light" href="{{ route('sign up', compact('lang')) }}">
                        {{ trans('messages.Sign up') }}
                        <i class="mdi-content-add-circle material-icons left"></i>
                    </a>
                    <a class="btn-flat waves-effect waves-light"  href="{{ route('sign in', compact('lang')) }}">
